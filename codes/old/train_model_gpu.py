...
def Test_loc(model, device, testdatapath, Num_classes):
    ...
    for k in range(Num_classes):
        ...
        dataloader = torch.utils.data.DataLoader(dataset, batch_size=1000, shuffle=False, num_workers=8, pin_memory=True)
...
#network = torch.load('../offline/conv_white/FCNN_white.pth')
...
dataloader_train = torch.utils.data.DataLoader(data_train, batch_size=1000, shuffle=True, num_workers=12, pin_memory=True)
