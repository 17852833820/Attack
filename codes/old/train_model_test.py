...
def Train_loc(model, dataloader_train, device, num_epochs=200):
    ...
    if isinstance(model, torch.nn.DataParallel):
        torch.save(model.module, '../offline/fcnn_white/FCNN_white_best1.pth')
    else:
        torch.save(model, '../offline/fcnn_white/FCNN_white_best1.pth')
...
def Test_loc(model, device, testdatapath, Num_classes):
    ...
    pickle.dump(errs_all, open("../offline/fcnn_white/FCNN_White_best1_meta_error_all_info.pkl", "wb"))
    pickle.dump(errs_90_all, open("../offline/fcnn_white/FCNN_White_best1_meta_error90_info.pkl", "wb"))
